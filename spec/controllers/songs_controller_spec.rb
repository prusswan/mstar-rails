  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved song as @song" do
        ...
        post :create, {:song => { "mstar_id" => "invalid value" }}, valid_session
        assigns(:song).should be_a_new(Song)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested song" do
        ...
        Song.any_instance.should_receive(:update_attributes).with({ "mstar_id" => "MyString" })
        put :update, {:id => song.to_param, :song => { "mstar_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the song as @song" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Song.any_instance.stub(:save).and_return(false)
        put :update, {:id => song.to_param, :song => { "mstar_id" => "invalid value" }}, valid_session
        assigns(:song).should eq(song)
      end
